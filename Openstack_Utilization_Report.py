...
base_url = "http://10.43.10.3"
admin_username = "admin"
admin_password = "devops123"
admin_domain = "Default"
ceph_rest_api = "http://10.43.11.155:5000"
...
for project in projects['projects']:
    for usage in projects_usage['tenant_usages']:
        if project['id'] == usage['tenant_id']:
            ...
            project['usagedata'] = json.loads(json.dumps(usagedata))
...
reportfile.writerow(["Project Name","VCPUs Used", "VCPUs Allocated", "RAM Used(GB)", "RAM Allocated(GB)", "Disk Used(GB)", "Instances used", "Instances Allocated", "Volumes Used", "Volumes Allocated", "Storage Used(GB)", "Storage Allocated(GB)", "No of Users"])
